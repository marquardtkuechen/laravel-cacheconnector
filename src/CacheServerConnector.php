...
class CacheServerConnector extends Connector implements ConnectorInterface
{
    /**
     ...
     * @var array
     */
    protected $cache_dsn_attributes = [
        //        "Addr",
        //        "Address",
        "AnsiNPW",
        "APP",
    ...
    protected function getDsn(array $config)
    {
        ...
        if (in_array('odbc', $this->getAvailableDrivers())) {
            ...
            return $this->getCacheSrvDsn($config);
        }
    }
    ...
    protected function getOdbcDsn(array $config)
    {
        ...
        $arguments = array_merge(
            $arguments,
            Arr::only($config, $this->cache_dsn_attributes)
        );
     ...
     * @return string
     */
    protected function getCacheSrvDsn(array $config)
    {
        $arguments = [
            'Server' => $this->buildHostString($config, ','),
        ];
